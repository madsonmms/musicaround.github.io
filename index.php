                ...
                <div class="container text-center titulo hidden">
                    <div class="col-sm-12">
                        ...
                        <div class="col-sm-12">
                                    ...
                                    <form class="form-horizontal" name="login" method="post" action="login.php">
                                        <div class="col-lg-12">
                                            <div class="form-group">
                                                ...
                                                <input class="form-control" type="text" placeholder="E-mail" name="frmEmail" tabindex="1" required>
                                            </div>
                                        </div>
                                        <div class="col-sm-12">
                                            <div class="form-group">
                                                <label for="frmSenha">Senha:</label>
                                                <input class="form-control" type="password" placeholder="Senha" name="frmSenha" tabindex="2" required>
                                            </div>
                                            <div class="form-group">
                                                <input type="submit" class="btn btn-success btn-block" name="entrar" value="Entrar" tabindex="3">
                                            </div>
                            ...
                            <div class="col-sm-6">
                                <fieldset>
                                    <legend>Use as redes sociais</legend>
                            ...
                            <div class="col-sm-12">
                                <fieldset>
                                    <div class="col-sm-12">
                                        ...
                                        <a href="cadastro.php" class="btn btn-xs btn-danger">
                                            <h2>Cadastre-se!</h2>
                                        </a>
                                    </div>
                                </fieldset>
